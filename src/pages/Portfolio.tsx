...
import { FaWallet, FaFlag } from "react-icons/fa";
...
const Portfolio: React.FC = () => {
  ...
  const tokensDropdownRef = useRef<HTMLDivElement | null>(null);
  const stakedDropDownRef = useRef<HTMLDivElement | null>(null); // Fixed to Div instead of List
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        stakedDropDownRef.current &&
        !stakedDropDownRef.current.contains(event.target as Node)
      ) {
        setDropdownVisible(false); // Close staked dropdown
      }
    };
          ...
          <div className="border border-pink-900 mt-2 rounded-xl">
            ...
            <div className="flex gap-x-3">
              <div className="flex justify-between rounded-lg bg-[#061230] w-[50%] pl-4 ml-4 mt-2 mb-4 items-center">
                ...
                <Image src={RobinoLogo} alt="Robino" className="pr-2 w-[48px]" />
              </div>
              <div className="flex justify-between rounded-lg bg-[#061230] w-[50%] pl-4 mt-2 mb-4 mr-4 items-center">
                ...
                <Image src={USDM} alt="USDM" className="pr-2 w-[48px]" />
              </div>
            </div>
          </div>

          {/* Versus Event Section */}
                ...
                <div className="flex justify-between w-full p-2">
                  ...
                  <div className="dropdown">
                    <div className="flex items-center h-[50px] p-[2px] relative">
                      <button
                        type="button"
                        className="group h-full items-center rounded-[10px] border border-slate-500 text-white disabled:cursor-not-allowed disabled:opacity-50 flex rounded-r-[10px] px-[15px] justify-center"
            ...
            <div className="flex flex-col lg:flex-row gap-[10px] items-center">
              ...
              <div className="flex flex-col md:flex-row lg:grow gap-[10px] relative">
                ...
                {isTokensDropdownOpen && (
                  <div ref={tokensDropdownRef}>
                    <ul
                      className="absolute top-[70px] z-10 bg-[#061230] text-white rounded-[10px] w-[50%] left-0 p-2 shadow-md"
                    >
                ...
                {isSportsDropdownOpen && (
                  <div ref={sportsDropdownRef}>
                    <ul
                      className="absolute top-[70px] left-[50%] w-[50%] z-10 bg-[#061230] text-white rounded-[10px] p-2 shadow-md"
                    >
                      {[
                        "League",
                        "Seria A 24/25",
