  ...
  return (
    <div className="flex relative bg-gradient">
      ...
      <div className="mt-[100px] ml-[100px]">
        ...
        {/* wallet div  */}
        <div className=" border border-pink-900 mt-2 rounded-xl w-[980px]">
        ...
        <div className=" border border-pink-900 mt-4 rounded-xl w-[980px]">
          {/* wallet text with icon  */}
          <div className="text-white gap-x-4 flex items-center text-[20px] pl-4 pt-2">
        ...
        Bet History
          ...
          {/* 5 words wala last div  */}
           <div className="flex  border-black border-4 mt-4 py-4 rounded-xl text-slate-500 justify-evenly     ">
                <div>Event</div>
                <div>League</div>
                <div>Token</div>
                <div>Stake</div>
           ...
           <div className="bg-white w-[930px] mt-[-5px] ml-[8px] absolute h-[1px]">
